...
export const Gabebook = ({ className }) => {
    return (
        <div className={className}>
            ...
            <div className="passage-text">
                Controllers can access any models they need. For example, the likePost controller as seen above uses queries from the PostModel, LikesModel, and UserModel.
                This allows models to be specific and used by a variety of controllers, which helps with code maintainability and expandability.
            </div>
            <div className="passage-text">
                This request/response pattern, which dynamically updates views, drives most of the application's core functionality that users directly interact with. Now, we'll explore some interal server-side features:
            </div>
            <div className="passage-text">
